...
function main() {
  ...
  Logger.log(getFirstDayWeek(event.date));
  Logger.log(Utilities.formatDate(getFirstDayWeek(event.date), 'GMT', 'MMM dd-MM-YY'));
  Logger.log(event.formattedTitle);
